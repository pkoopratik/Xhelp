...
function useTheme2() {
  const theme = (0, import_react3.useContext)(
    ThemeContext
  );
  if (!theme) {
    throw Error(
...
function getOwnerWindow(node2) {
  var _a2, _b;
  return isElement(node2) ? (_b = (_a2 = getOwnerDocument(node2)) == null ? void 0 : _a2.defaultView) != null ? _b : window : window;
}
function getOwnerDocument(node2) {
  var _a2;
  return isElement(node2) ? (_a2 = node2.ownerDocument) != null ? _a2 : document : document;
}
...
function styled(component, options) {
  ...
  const chakraComponent = import_react8.default.forwardRef(function ChakraComponent(props, ref) {
...
function forwardRef3(component) {
  return (0, import_react9.forwardRef)(component);
}
...
function createContext2(options = {}) {
  ...
  function useContext6() {
    ...
    if (!context && strict) {
      ...
      (_a2 = Error.captureStackTrace) == null ? void 0 : _a2.call(Error, error2, useContext6);
      throw error2;
    }
    return context;
  }
...
function ThemeProvider3(props) {
  ...
  const computedTheme = (0, import_react13.useMemo)(() => toCSSVar(theme), [theme]);
...
function createContext3(options = {}) {
  ...
  const Context = (0, import_react15.createContext)(defaultValue);
  Context.displayName = name;
  function useContext6() {
    var _a2;
  ...
  return [Context.Provider, useContext6, Context];
}

// node_modules/@chakra-ui/react-children-utils/dist/index.mjs
var import_react16 = __toESM(require_react(), 1);
function getValidChildren2(children) {
  return import_react16.Children.toArray(children).filter(
    (child) => (0, import_react16.isValidElement)(child)
  );
}
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VHRO3W23.js.map
