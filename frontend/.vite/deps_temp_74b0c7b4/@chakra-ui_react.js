...
function useCreateMotionContext(props) {
  const { initial, animate: animate2 } = getCurrentTreeVariants(props, (0, import_react14.useContext)(MotionContext));
  return (0, import_react14.useMemo)(() => ({ initial, animate: animate2 }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate2)]);
}
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component2 !== import_react20.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
    const { children } = props;
    const renderedChildren = (0, import_react20.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
    return (0, import_react20.createElement)(Component2, {
      ...elementProps,
...
function MeasureLayout(props) {
  ...
  return import_react24.default.createElement(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react24.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  return React4.createElement(React4.Fragment, null, exitingChildren.size ? childrenToRender : childrenToRender.map((child) => (0, import_react30.cloneElement)(child)));
};
...
var ReorderContext = (0, import_react35.createContext)(null);
...
function ReorderGroup({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  const order2 = [];
  const isReordering = (0, import_react36.useRef)(false);
...
var Group = (0, import_react36.forwardRef)(ReorderGroup);
...
function ReorderItem({ children, style = {}, value, as = "li", onDrag, layout: layout3 = true, ...props }, externalRef) {
  const Component2 = useConstant(() => motion(as));
  const context = (0, import_react38.useContext)(ReorderContext);
  const point = {
...
var Item = (0, import_react38.forwardRef)(ReorderItem);
...
var ToastComponent = (0, import_react51.memo)((props) => {
  const {
    id: id3,
    message,
    onCloseComplete,
  ...
  const [delay2, setDelay] = (0, import_react51.useState)(duration);
  ...
  const containerStyles = (0, import_react51.useMemo)(
    () => ({
      pointerEvents: "auto",
      maxWidth: 560,
      minWidth: 300,
  ...
  const toastStyle = (0, import_react51.useMemo)(() => getToastStyle(position2), [position2]);
...
var ToastProvider = (props) => {
  const state = (0, import_react52.useSyncExternalStore)(
...
var useSafeLayoutEffect2 = typeof window !== "undefined" ? import_react54.useLayoutEffect : import_react54.useEffect;
...
function useDescendants() {
  const descendants = (0, import_react56.useRef)(new DescendantsManager());
...
function useDescendant(options) {
  ...
  const [index, setIndex] = (0, import_react56.useState)(-1);
...
function useAccordion(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react58.useState)(-1);
...
function useAccordionItem(props) {
  ...
  const getButtonProps = (0, import_react58.useCallback)(
  ...
  const getPanelProps = (0, import_react58.useCallback)(
...
var AccordionItem = forwardRef(
  function AccordionItem2(props, ref) {
    ...
    const ctx = (0, import_react59.useMemo)(() => context, [context]);
...
var Collapse = (0, import_react60.forwardRef)(
  (props, ref) => {
    const {
      in: isOpen,
      unmountOnExit,
...
var ScaleFade = (0, import_react62.forwardRef)(
...
var SlideFade = (0, import_react63.forwardRef)(
...
var Slide = (0, import_react64.forwardRef)(function Slide2(props, ref) {
  const {
    direction = "right",
    style,
    unmountOnExit,
...
var Accordion = forwardRef(function Accordion2({ children, reduceMotion, ...props }, ref) {
  ...
  const ctx = (0, import_react65.useMemo)(
...
var BreadcrumbLink = forwardRef(
  function BreadcrumbLink2(props, ref) {
    ...
    if (isCurrentPage) {
      return (0, import_jsx_runtime28.jsx)(chakra.span, { "aria-current": "page", __css: styles.link, ...sharedProps });
    }
    return (0, import_jsx_runtime28.jsx)(chakra.a, { __css: styles.link, href, ...sharedProps });
  }
);
  ...
  function BreadcrumbItem2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      if (child.type === BreadcrumbLink) {
        return (0, import_react66.cloneElement)(child, {
          isCurrentPage
        });
      }
    ...
    return (0, import_jsx_runtime30.jsxs)(chakra.li, { ref, className: _className, ...rest, __css: itemStyles, children: [
      clones,
      !isLastChild && (0, import_jsx_runtime30.jsx)(BreadcrumbSeparator, { spacing, children: separator })
    ] });
  }
);
...
var Breadcrumb = forwardRef(
  function Breadcrumb2(props, ref) {
    ...
    const clones = validChildren.map(
      (child, index) => (0, import_react67.cloneElement)(child, {
        separator,
        spacing,
    ...
    return (0, import_jsx_runtime31.jsx)(
      chakra.nav,
      {
        ...
        ...rest,
        children: (0, import_jsx_runtime31.jsx)(BreadcrumbStylesProvider, { value: styles, children: (0, import_jsx_runtime31.jsx)(
          chakra.ol,
          {
...
var ButtonGroup = forwardRef(
  function ButtonGroup2(props, ref) {
    ...
    return (0, import_jsx_runtime32.jsx)(ButtonGroupProvider, { value: context, children: (0, import_jsx_runtime32.jsx)(
      chakra.div,
      {
        ref,
        role: "group",
...
function useButtonType(value) {
  const [isButton, setIsButton] = (0, import_react69.useState)(!value);
  const refCallback = (0, import_react69.useCallback)((node2) => {
    if (!node2)
      return;
...
function ButtonIcon(props) {
  ...
  const _children = (0, import_react70.isValidElement)(children) ? (0, import_react70.cloneElement)(children, {
    "aria-hidden": true,
    focusable: false
  }) : children;
...
function ButtonSpinner(props) {
  const {
    ...
    placement,
    spacing = "0.5rem",
    children = (0, import_jsx_runtime34.jsx)(Spinner, { color: "currentColor", width: "1em", height: "1em" }),
    className,
    __css,
    ...rest
  } = props;
  ...
  const spinnerStyles = (0, import_react71.useMemo)(
    () => ({
      display: "flex",
      alignItems: "center",
  ...
  return (0, import_jsx_runtime34.jsx)(chakra.div, { className: _className, ...rest, __css: spinnerStyles, children });
}
...
var Button = forwardRef((props, ref) => {
  ...
  const buttonStyles = (0, import_react72.useMemo)(() => {
  ...
  return (0, import_jsx_runtime35.jsxs)(
    chakra.button,
    {
      ...
      children: [
        isLoading && spinnerPlacement === "start" && (0, import_jsx_runtime35.jsx)(
          ButtonSpinner,
          {
        ...
        isLoading ? loadingText || (0, import_jsx_runtime35.jsx)(chakra.span, { opacity: 0, children: (0, import_jsx_runtime35.jsx)(ButtonContent, { ...contentProps }) }) : (0, import_jsx_runtime35.jsx)(ButtonContent, { ...contentProps }),
        isLoading && spinnerPlacement === "end" && (0, import_jsx_runtime35.jsx)(
          ButtonSpinner,
          {
...
function ButtonContent(props) {
  ...
  return (0, import_jsx_runtime35.jsxs)(import_jsx_runtime35.Fragment, { children: [
    leftIcon && (0, import_jsx_runtime35.jsx)(ButtonIcon, { marginEnd: iconSpacing, children: leftIcon }),
    children,
    rightIcon && (0, import_jsx_runtime35.jsx)(ButtonIcon, { marginStart: iconSpacing, children: rightIcon })
  ] });
}
...
var IconButton = forwardRef(
  (props, ref) => {
    ...
    const _children = (0, import_react73.isValidElement)(element) ? (0, import_react73.cloneElement)(element, {
      "aria-hidden": true,
      focusable: false
    }) : null;
...
var Card = forwardRef(function Card2(props, ref) {
  ...
  return (0, import_jsx_runtime40.jsx)(
    chakra.div,
    {
      ...
      ...rest,
      children: (0, import_jsx_runtime40.jsx)(CardStylesProvider, { value: styles, children })
    }
  );
});
...
function useCheckboxGroup(props = {}) {
  ...
  const getCheckboxProps = (0, import_react74.useCallback)(
    (props2 = {}) => {
...
function CheckboxGroup(props) {
  ...
  const group = (0, import_react75.useMemo)(
    () => ({
      size,
      onChange,
      colorScheme,
  ...
  return (0, import_jsx_runtime41.jsx)(CheckboxGroupProvider, { value: group, children });
}
...
function CheckIcon2(props) {
  return (0, import_jsx_runtime42.jsx)(
    chakra.svg,
    {
      ...
      ...props,
      children: (0, import_jsx_runtime42.jsx)("polyline", { points: "1.5 6 4.5 9 10.5 1" })
    }
  );
}
function IndeterminateIcon(props) {
  return (0, import_jsx_runtime42.jsx)(
    chakra.svg,
    {
      ...
      ...props,
      children: (0, import_jsx_runtime42.jsx)("line", { x1: "21", x2: "3", y1: "12", y2: "12" })
    }
  );
}
function CheckboxIcon(props) {
  ...
  return isChecked || isIndeterminate ? (0, import_jsx_runtime42.jsx)(
    chakra.div,
    {
      style: {
        display: "flex",
      ...
      children: (0, import_jsx_runtime42.jsx)(BaseIcon, { ...rest })
    }
  ) : null;
}
...
function useFormControlProvider(props) {
  ...
  const [hasFeedbackText, setHasFeedbackText] = (0, import_react77.useState)(false);
  const [hasHelpText, setHasHelpText] = (0, import_react77.useState)(false);
  const [isFocused, setFocus] = (0, import_react77.useState)(false);
  const getHelpTextProps = (0, import_react77.useCallback)(
  ...
  const getErrorMessageProps = (0, import_react77.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      id: feedbackId,
      ...props2,
      /**
  ...
  const getRequiredIndicatorProps = (0, import_react77.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
      ref: forwardedRef,
      role: "presentation",
...
var FormControl = forwardRef(
  function FormControl2(props, ref) {
    ...
    return (0, import_jsx_runtime43.jsx)(FormControlProvider, { value: context, children: (0, import_jsx_runtime43.jsx)(FormControlStylesProvider, { value: styles, children: (0, import_jsx_runtime43.jsx)(
      chakra.div,
      {
        ...getRootProps({}, ref),
        className,
...
var FormErrorMessage = forwardRef(
  (props, ref) => {
    ...
    if (!(field == null ? void 0 : field.isInvalid))
      return null;
    return (0, import_jsx_runtime44.jsx)(FormErrorStylesProvider, { value: styles, children: (0, import_jsx_runtime44.jsx)(
      chakra.div,
      {
...
var FormLabel = forwardRef(function FormLabel2(passedProps, ref) {
  ...
  const {
    className,
    children,
    requiredIndicator = (0, import_jsx_runtime45.jsx)(RequiredIndicator, {}),
...
function useCheckbox(props = {}) {
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react78.useState)(false);
  const [isFocused, setFocused] = (0, import_react78.useState)(false);
  const [isHovered, setHovered] = (0, import_react78.useState)(false);
  const [isActive, setActive] = (0, import_react78.useState)(false);
  (0, import_react78.useEffect)(() => {
    return trackFocusVisible(setIsFocusVisible);
  }, []);
  const inputRef = (0, import_react78.useRef)(null);
  const [rootIsLabelElement, setRootIsLabelElement] = (0, import_react78.useState)(true);
  const [checkedState, setCheckedState] = (0, import_react78.useState)(!!defaultChecked);
  ...
  const onKeyUp = (0, import_react78.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
  ...
  const getCheckboxProps = (0, import_react78.useCallback)(
    (props2 = {}, forwardedRef = null) => {
  ...
  const getIndicatorProps = (0, import_react78.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
      ref: forwardedRef,
      "data-active": dataAttr(isActive),
  ...
  const getRootProps = (0, import_react78.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...htmlProps,
      ...props2,
      ref: mergeRefs(forwardedRef, (node2) => {
...
var Checkbox = forwardRef(function Checkbox2(props, ref) {
  ...
  const {
    ...
    iconColor,
    iconSize,
    icon = (0, import_jsx_runtime46.jsx)(CheckboxIcon, {}),
  ...
  const iconStyles = (0, import_react79.useMemo)(
    () => ({
  ...
  const clonedIcon = (0, import_react79.cloneElement)(icon, {
    __css: iconStyles,
...
function useCounter(props = {}) {
  ...
  const onChangeProp = useCallbackRef(onChange);
  const [valueState, setValue] = (0, import_react80.useState)(() => {
    var _a2;
  ...
  const update = (0, import_react80.useCallback)(
    (next) => {
      if (next === value)
        return;
      if (!isControlled) {
  ...
  const clamp2 = (0, import_react80.useCallback)(
    (value2) => {
  ...
  const increment = (0, import_react80.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse(step);
  ...
  const decrement = (0, import_react80.useCallback)(
    (step = stepProp) => {
      let next;
      if (value === "") {
        next = parse(-step);
  ...
  const castValue = (0, import_react80.useCallback)(
    (value2) => {
      var _a2;
...
function useEditable(props = {}) {
  ...
  const [isEditing, setIsEditing] = (0, import_react82.useState)(defaultIsEditing);
  const [value, setValue] = useControllableState({
    defaultValue: defaultValue || "",
    value: valueProp,
    onChange: onChangeProp
  });
  const [prevValue, setPrevValue] = (0, import_react82.useState)(value);
  const inputRef = (0, import_react82.useRef)(null);
  const previewRef = (0, import_react82.useRef)(null);
  const editButtonRef = (0, import_react82.useRef)(null);
  const cancelButtonRef = (0, import_react82.useRef)(null);
  const submitButtonRef = (0, import_react82.useRef)(null);
  ...
  const onEdit = (0, import_react82.useCallback)(() => {
    if (isInteractive) {
      setIsEditing(true);
    }
  }, [isInteractive]);
  const onUpdatePrevValue = (0, import_react82.useCallback)(() => {
    setPrevValue(value);
  }, [value]);
  const onCancel = (0, import_react82.useCallback)(() => {
    setIsEditing(false);
    setValue(prevValue);
    onCancelProp == null ? void 0 : onCancelProp(prevValue);
    onBlurProp == null ? void 0 : onBlurProp(prevValue);
  }, [onCancelProp, onBlurProp, setValue, prevValue]);
  const onSubmit = (0, import_react82.useCallback)(() => {
    setIsEditing(false);
    setPrevValue(value);
  ...
  const onKeyDownWithoutSubmit = (0, import_react82.useCallback)(
    (event) => {
      const eventKey = event.key;
      const keyMap = {
        Escape: onCancel
  ...
  const onBlur3 = (0, import_react82.useCallback)(
    (event) => {
      var _a2;
      if (!isEditing)
        return;
  ...
  const getPreviewProps = (0, import_react82.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getTextareaProps = (0, import_react82.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      hidden: !isEditing,
      placeholder,
  ...
  const getEditButtonProps = (0, import_react82.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Edit",
      ...props2,
      type: "button",
  ...
  const getSubmitButtonProps = (0, import_react82.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      "aria-label": "Submit",
  ...
  const getCancelButtonProps = (0, import_react82.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Cancel",
      id: "cancel",
      ...props2,
...
var focusScope = (0, import_react86.createContext)(void 0);
  ...
  return function wrap4(WrappedComponent) {
    ...
    var SideEffect = function(_PureComponent) {
      ...
      _proto.render = function render() {
        return import_react87.default.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
    }(import_react87.PureComponent);
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react90.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react90.useCallback)(() => {
    var _a2;
...
function useShortcut(props = {}) {
  ...
  const [keys, setKeys] = (0, import_react92.useState)([]);
...
var useSafeLayoutEffect3 = isBrowser ? import_react93.useLayoutEffect : import_react93.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-KA2477BY.mjs
var import_react94 = __toESM(require_react(), 1);
function useCallbackRef3(fn2, deps = []) {
  const ref = (0, import_react94.useRef)(fn2);
  useSafeLayoutEffect3(() => {
    ref.current = fn2;
  });
  return (0, import_react94.useCallback)((...args) => {
    var _a2;
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react96.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react101.useRef)();
...
function useOutsideClick(props) {
  ...
  const stateRef = (0, import_react102.useRef)({
    isPointerDown: false,
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react104.useRef)(null);
  const handlers2 = {
...
function useId6(idProp, prefix) {
  const id3 = (0, import_react105.useId)();
...
function useOptionalPart(partId) {
  const [id3, setId] = (0, import_react105.useState)(null);
  const ref = (0, import_react105.useCallback)(
    (node2) => {
...
function useControllableState2(props) {
  ...
  const [valueState, setValue] = (0, import_react106.useState)(defaultValue);
  const isControlled = valueProp !== void 0;
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react106.useCallback)(
    (next) => {
...
function useDisclosure(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react107.useState)(props.defaultIsOpen || false);
  ...
  const onToggle = (0, import_react107.useCallback)(() => {
...
function useEventListenerMap() {
  const listeners = (0, import_react108.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add = (0, import_react108.useCallback)((el, type, listener, options) => {
  ...
  const remove = (0, import_react108.useCallback)(
...
var useUpdateEffect2 = (effect5, deps) => {
  const renderCycleRef = (0, import_react109.useRef)(false);
  const effectCycleRef = (0, import_react109.useRef)(false);
...
function useFocusOnShow(target, options = defaultOptions2) {
  ...
  const autoFocusRef = (0, import_react110.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react110.useRef)(visible);
  useSafeLayoutEffect3(() => {
  ...
  const onFocus3 = (0, import_react110.useCallback)(() => {
...
function useForceUpdate2() {
  const unloadingRef = (0, import_react111.useRef)(false);
  const [count, setCount] = (0, import_react111.useState)(0);
  useUnmountEffect2(() => {
...
function useAnimationState(props) {
  ...
  const [mounted, setMounted] = (0, import_react112.useState)(isOpen);
  const [once, setOnce] = (0, import_react112.useState)(false);
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react113.useState)(initialState2);
  const callbacks = (0, import_react113.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react114.useState)(false);
  const [valueState, setValueState] = (0, import_react114.useState)(value);
  (0, import_react114.useEffect)(() => setValueState(value), [value]);
  const { timeout = 1500, ...copyOptions } = typeof optionsOrTimeout === "number" ? { timeout: optionsOrTimeout } : optionsOrTimeout;
  const onCopy = (0, import_react114.useCallback)(() => {
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react116.useState)(null);
  const rafId = (0, import_react116.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node2 = ref.current;
      if (!node2)
...
var InputGroup = forwardRef(
  function InputGroup2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      ...
      return child.type.id !== "Input" ? (0, import_react117.cloneElement)(child, theming) : (0, import_react117.cloneElement)(child, Object.assign(theming, groupStyles, child.props));
    });
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react118.useState)(() => {
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys, setKeys] = (0, import_react119.useState)([]);
...
function useEventListeners() {
  const listeners = (0, import_react120.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add = (0, import_react120.useCallback)((el, type, listener, options) => {
    listeners.current.set(listener, { type, el, options });
    el.addEventListener(type, listener, options);
  }, []);
  const remove = (0, import_react120.useCallback)(
    (el, type, listener, options) => {
...
function useClickable(props = {}) {
  ...
  const [isButton, setIsButton] = (0, import_react121.useState)(true);
  const [isPressed, setIsPressed] = (0, import_react121.useState)(false);
  ...
  const onDocumentKeyUp = (0, import_react121.useCallback)(
    (e) => {
  ...
  const handleKeyUp = (0, import_react121.useCallback)(
    (event) => {
  ...
  const onDocumentMouseUp = (0, import_react121.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      setIsPressed(false);
  ...
  const handleMouseDown = (0, import_react121.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (isDisabled2) {
  ...
  const handleMouseUp = (0, import_react121.useCallback)(
    (event) => {
      if (event.button !== 0)
        return;
      if (!isButton) {
  ...
  const handleMouseOver = (0, import_react121.useCallback)(
    (event) => {
      if (isDisabled2) {
        event.preventDefault();
        return;
  ...
  const handleMouseLeave = (0, import_react121.useCallback)(
    (event) => {
      if (isPressed) {
        event.preventDefault();
        setIsPressed(false);
...
function useFocusOnShow2(target, options = defaultOptions3) {
  ...
  const autoFocusValue = shouldFocus && visible;
  const autoFocusRef = (0, import_react122.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react122.useRef)(visible);
  useSafeLayoutEffect(() => {
    if (!lastVisibleRef.current && visible) {
      autoFocusRef.current = autoFocusValue;
    }
  ...
  const onFocus3 = (0, import_react122.useCallback)(() => {
    if (!visible || !element || !autoFocusRef.current)
      return;
    autoFocusRef.current = false;
...
function usePopper(props = {}) {
  ...
  const referenceRef = (0, import_react123.useCallback)(
    (node2) => {
  ...
  const getReferenceProps = (0, import_react123.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const popperRef = (0, import_react123.useCallback)(
    (node2) => {
  ...
  const getPopperProps = (0, import_react123.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
  ...
  const getArrowInnerProps = (0, import_react123.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-popper-arrow-inner": ""
...
function useAnimationState2(props) {
  const { isOpen, ref } = props;
  const [mounted, setMounted] = (0, import_react126.useState)(isOpen);
  const [once, setOnce] = (0, import_react126.useState)(false);
...
function useMenu(props = {}) {
  ...
  const menuRef = (0, import_react127.useRef)(null);
  const buttonRef = (0, import_react127.useRef)(null);
  const descendants = useMenuDescendants();
  const focusMenu = (0, import_react127.useCallback)(() => {
    requestAnimationFrame(() => {
      var _a2;
      (_a2 = menuRef.current) == null ? void 0 : _a2.focus({ preventScroll: false });
    });
  }, []);
  const focusFirstItem = (0, import_react127.useCallback)(() => {
  ...
  const focusLastItem = (0, import_react127.useCallback)(() => {
    const id22 = setTimeout(() => {
      const last = descendants.lastEnabled();
      if (last)
  ...
  const onOpenInternal = (0, import_react127.useCallback)(() => {
  ...
  const openAndFocusMenu = (0, import_react127.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react127.useRef)(/* @__PURE__ */ new Set([]));
  ...
  const openAndFocusFirstItem = (0, import_react127.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react127.useCallback)(() => {
    onOpen();
    focusLastItem();
  }, [onOpen, focusLastItem]);
  const refocus = (0, import_react127.useCallback)(() => {
    var _a2, _b;
  ...
  const rafId = (0, import_react127.useRef)(null);
  return {
    openAndFocusMenu,
...
function useMenuList(props = {}, ref = null) {
  ...
  const hasBeenOpened = (0, import_react127.useRef)(false);
  if (isOpen) {
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id3 = `${menuId}-menuitem-${(0, import_react127.useId)()}`;
  const { index, register } = useMenuDescendant({
    disabled: isDisabled2 && !isFocusable2
  });
  const onMouseEnter = (0, import_react127.useCallback)(
    (event) => {
  ...
  const onMouseMove = (0, import_react127.useCallback)(
    (event) => {
  ...
  const onMouseLeave = (0, import_react127.useCallback)(
    (event) => {
  ...
  const onClick = (0, import_react127.useCallback)(
    (event) => {
...
var Menu = (props) => {
  ...
  const context = (0, import_react128.useMemo)(() => ctx, [ctx]);
...
var StyledMenuItem = forwardRef(
  (props, ref) => {
    ...
    const buttonStyles = (0, import_react129.useMemo)(
      () => ({
        textDecoration: "none",
        color: "inherit",
        userSelect: "none",
...
var MenuIcon = (props) => {
  ...
  const clone = (0, import_react130.isValidElement)(child) ? (0, import_react130.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
    className: cx("chakra-menu__icon", child.props.className)
  }) : null;
  const _className = cx("chakra-menu__icon-wrapper", className);
  return (0, import_jsx_runtime62.jsx)(chakra.span, { className: _className, ...rest, __css: styles.icon, children: clone });
};
...
var CheckIcon3 = (props) => (0, import_jsx_runtime69.jsx)("svg", { viewBox: "0 0 14 14", width: "1em", height: "1em", ...props, children: (0, import_jsx_runtime69.jsx)(
  "polygon",
  {
    fill: "currentColor",
        ...
        children: [
          icon !== null && (0, import_jsx_runtime69.jsx)(
            MenuIcon,
            {
              ...
              children: icon || (0, import_jsx_runtime69.jsx)(CheckIcon3, {})
            }
          ),
...
var ModalTransition = (0, import_react131.forwardRef)(
  (props, ref) => {
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react132.useState)(0);
...
function useModal(props) {
  ...
  const getDialogProps = (0, import_react133.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react133.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react133.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useSpinner(increment, decrement) {
  const [isSpinning, setIsSpinning] = (0, import_react139.useState)(false);
  const [action, setAction] = (0, import_react139.useState)(null);
  const [runOnce, setRunOnce] = (0, import_react139.useState)(true);
  const timeoutRef = (0, import_react139.useRef)(null);
  ...
  const up = (0, import_react139.useCallback)(() => {
    if (runOnce) {
      increment();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const down = (0, import_react139.useCallback)(() => {
    if (runOnce) {
      decrement();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const stop = (0, import_react139.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const inputSelectionRef = (0, import_react140.useRef)(null);
  const incrementButtonRef = (0, import_react140.useRef)(null);
  const decrementButtonRef = (0, import_react140.useRef)(null);
  const sanitize2 = (0, import_react140.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse3 = (0, import_react140.useCallback)(
    (value) => {
      var _a2;
  ...
  const format = (0, import_react140.useCallback)(
    (value) => {
      var _a2;
  ...
  const increment = (0, import_react140.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        incrementFn(step);
      }
  ...
  const decrement = (0, import_react140.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        decrementFn(step);
      }
  ...
  const _onFocus = (0, import_react140.useCallback)(
    (event) => {
      var _a2, _b, _c;
  ...
  const ariaValueText = (0, import_react140.useMemo)(() => {
  ...
  const validateAndClamp = (0, import_react140.useCallback)(() => {
  ...
  const onInputBlur = (0, import_react140.useCallback)(() => {
    setFocused(false);
    if (clampValueOnBlur) {
      validateAndClamp();
    }
  }, [clampValueOnBlur, setFocused, validateAndClamp]);
  const focusInput = (0, import_react140.useCallback)(() => {
  ...
  const spinUp = (0, import_react140.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.up();
      focusInput();
  ...
  const spinDown = (0, import_react140.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.down();
      focusInput();
  ...
  const getIncrementButtonProps = (0, import_react140.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getDecrementButtonProps = (0, import_react140.useCallback)(
    (props2 = {}, ref = null) => {
...
var NumberInput = forwardRef(
  function NumberInput2(props, ref) {
    ...
    const ctx = (0, import_react141.useMemo)(() => context, [context]);
...
function usePinInput(props = {}) {
  ...
  const uuid = (0, import_react142.useId)();
  const id3 = idProp != null ? idProp : `pin-input-${uuid}`;
  const descendants = usePinInputDescendants();
  const [moveFocus2, setMoveFocus] = (0, import_react142.useState)(true);
  const [focusedIndex, setFocusedIndex] = (0, import_react142.useState)(-1);
  ...
  const focusNext = (0, import_react142.useCallback)(
    (index) => {
  ...
  const setValue = (0, import_react142.useCallback)(
  ...
  const clear = (0, import_react142.useCallback)(() => {
    var _a2;
  ...
  const getNextValue = (0, import_react142.useCallback)((value2, eventValue) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react143.cloneElement)(child, { __css: styles })
  );
...
function PopoverTrigger(props) {
  ...
  return (0, import_react144.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function usePopover(props = {}) {
  ...
  const anchorRef = (0, import_react145.useRef)(null);
  const triggerRef = (0, import_react145.useRef)(null);
  const popoverRef = (0, import_react145.useRef)(null);
  const isHoveringRef = (0, import_react145.useRef)(false);
  const hasBeenOpened = (0, import_react145.useRef)(false);
  if (isOpen) {
    hasBeenOpened.current = true;
  }
  const [hasHeader, setHasHeader] = (0, import_react145.useState)(false);
  const [hasBody, setHasBody] = (0, import_react145.useState)(false);
  ...
  const getPopoverProps = (0, import_react145.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const popoverProps = {
        ...props2,
        style: {
  ...
  const getPopoverPositionerProps = (0, import_react145.useCallback)(
  ...
  const getAnchorProps = (0, import_react145.useCallback)(
    (props2, _ref2 = null) => {
      return {
        ...props2,
  ...
  const openTimeout = (0, import_react145.useRef)();
  const closeTimeout = (0, import_react145.useRef)();
  const maybeReferenceRef = (0, import_react145.useCallback)(
    (node2) => {
  ...
  const getTriggerProps = (0, import_react145.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getHeaderProps = (0, import_react145.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: headerId,
  ...
  const getBodyProps = (0, import_react145.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: bodyId,
      ref: mergeRefs(ref, (node2) => {
...
function PopoverAnchor(props) {
  ...
  return (0, import_react146.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react147.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react147.useRef)(null);
  const focus2 = (0, import_react147.useCallback)(() => {
  ...
  const getRootProps = (0, import_react147.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
  ...
  const getRadioProps = (0, import_react147.useCallback)(
    (props2 = {}, ref2 = null) => {
      const checkedKey = isNative ? "checked" : "isChecked";
      return {
        ...props2,
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  const group = (0, import_react148.useMemo)(
    () => ({
      name,
      size,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react149.useId)()}`;
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react149.useState)(false);
  const [isFocused, setFocused] = (0, import_react149.useState)(false);
  const [isHovered, setHovering] = (0, import_react149.useState)(false);
  const [isActive, setActive] = (0, import_react149.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react149.useState)(Boolean(defaultChecked));
  const isControlled = typeof isCheckedProp !== "undefined";
  const isChecked = isControlled ? isCheckedProp : isCheckedState;
  (0, import_react149.useEffect)(() => {
    return trackFocusVisible(setIsFocusVisible);
  }, []);
  const handleChange = (0, import_react149.useCallback)(
    (event) => {
      if (isReadOnly || isDisabled2) {
        event.preventDefault();
        return;
  ...
  const onKeyUp = (0, import_react149.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
  ...
  const getRadioProps = (0, import_react149.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-active": dataAttr(isActive),
...
var Radio = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime99.jsxs)(chakra.label, { className: "chakra-radio", ...rootProps, __css: rootStyles2, children: [
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react150.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime101.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react150.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react151.useRef)(true);
...
function usePrevious2(value) {
  const ref = (0, import_react152.useRef)();
...
var SkeletonText = (props) => {
  ...
  return (0, import_jsx_runtime104.jsx)(chakra.div, { className: _className, ...rest, children: numbers.map((number2, index) => {
    if (isLoaded && index > 0) {
      return null;
    }
...
var SkipNavLink = forwardRef(
  function SkipNavLink2(props, ref) {
    ...
    return (0, import_jsx_runtime105.jsx)(chakra.a, { ...rest, ref, href: `#${id3}`, __css: getStyles2(styles) });
  }
);
...
function usePanEvent(ref, options) {
  ...
  const panSession = (0, import_react154.useRef)(null);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react155.useLayoutEffect : import_react155.useEffect;
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react155.useState)([]);
  const [count, setCount] = (0, import_react155.useState)(0);
...
function useRangeSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react156.useState)(false);
  const [isFocused, setFocused] = (0, import_react156.useState)(false);
  const [activeIndex, setActiveIndex] = (0, import_react156.useState)(-1);
  const isInteractive = !(isDisabled2 || isReadOnly);
  const initialValue = (0, import_react156.useRef)(valueState);
  ...
  const isVertical = orientation === "vertical";
  const trackRef = (0, import_react156.useRef)(null);
  const rootRef = (0, import_react156.useRef)(null);
  ...
  const getValueFromPointer = (0, import_react156.useCallback)(
    (event) => {
      var _a2, _b;
      if (!trackRef.current)
        return;
  ...
  const actions = (0, import_react156.useMemo)(
    () => ({
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react156.useMemo)(
    () => getStyles3({
      isReversed,
      orientation,
      thumbRects,
  ...
  const focusThumb = (0, import_react156.useCallback)(
    (index) => {
      var _a2;
  ...
  const getTrackProps = (0, import_react156.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getInnerTrackProps = (0, import_react156.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react156.useCallback)(
    (props2, ref = null) => {
      var _a2;
      const { index, ...rest } = props2;
  ...
  const getOutputProps = (0, import_react156.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getMarkerProps = (0, import_react156.useCallback)(
    (props2, ref = null) => {
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react157.useMemo)(
      () => ({ ...context, name: sliderProps.name }),
      [context, sliderProps.name]
    );
    return (0, import_jsx_runtime106.jsx)(RangeSliderProvider, { value: ctx, children: (0, import_jsx_runtime106.jsx)(RangeSliderStylesProvider, { value: styles, children: (0, import_jsx_runtime106.jsx)(
      chakra.div,
      {
        ...getRootProps({}, ref),
  ...
  function RangeSliderThumb2(props, ref) {
    ...
    return (0, import_jsx_runtime106.jsxs)(
      chakra.div,
      {
        ...
        children: [
          thumbProps.children,
          name && (0, import_jsx_runtime106.jsx)("input", { ...getInputProps({ index: props.index }) })
        ]
      }
    );
  }
...
function useSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react158.useState)(false);
  ...
  const trackRef = (0, import_react158.useRef)(null);
  const thumbRef = (0, import_react158.useRef)(null);
  const rootRef = (0, import_react158.useRef)(null);
  const reactId = (0, import_react158.useId)();
  const uuid = idProp != null ? idProp : reactId;
  const [thumbId, trackId] = [`slider-thumb-${uuid}`, `slider-track-${uuid}`];
  const getValueFromPointer = (0, import_react158.useCallback)(
    (event) => {
      var _a22, _b;
      if (!trackRef.current)
        return;
  ...
  const constrain = (0, import_react158.useCallback)(
    (value2) => {
      const state2 = stateRef.current;
  ...
  const actions = (0, import_react158.useMemo)(
    () => ({
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react158.useMemo)(() => {
    const state2 = stateRef.current;
  ...
  const focusThumb = (0, import_react158.useCallback)(() => {
    const state2 = stateRef.current;
  ...
  const getRootProps = (0, import_react158.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ...htmlProps,
  ...
  const getTrackProps = (0, import_react158.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref: mergeRefs(ref, trackRef),
  ...
  const getInnerTrackProps = (0, import_react158.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react158.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getMarkerProps = (0, import_react158.useCallback)(
    (props2, ref = null) => {
...
var Slider = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime107.jsx)(SliderProvider, { value: context, children: (0, import_jsx_runtime107.jsx)(SliderStylesProvider, { value: styles, children: (0, import_jsx_runtime107.jsxs)(
    chakra.div,
    {
      ...rootProps,
      ...
      children: [
        ...
        (0, import_jsx_runtime107.jsx)("input", { ...inputProps })
      ]
    }
  ) }) });
});
...
var Stat = forwardRef(function Stat2(props, ref) {
  ...
  return (0, import_jsx_runtime108.jsx)(StatStylesProvider, { value: styles, children: (0, import_jsx_runtime108.jsx)(
    chakra.div,
    {
      ref,
      ...rest,
      ...
      __css: statStyles,
      children: (0, import_jsx_runtime108.jsx)("dl", { children })
    }
  ) });
});
...
var StatDownArrow = (props) => (0, import_jsx_runtime109.jsx)(Icon, { color: "red.400", ...props, children: (0, import_jsx_runtime109.jsx)(
  "path",
  {
    fill: "currentColor",
    d: "M21,5H3C2.621,5,2.275,5.214,2.105,5.553C1.937,5.892,1.973,6.297,2.2,6.6l9,12 c0.188,0.252,0.485,0.4,0.8,0.4s0.611-0.148,0.8-0.4l9-12c0.228-0.303,0.264-0.708,0.095-1.047C21.725,5.214,21.379,5,21,5z"
...
function StatUpArrow(props) {
  return (0, import_jsx_runtime109.jsx)(Icon, { color: "green.400", ...props, children: (0, import_jsx_runtime109.jsx)(
    "path",
    {
      fill: "currentColor",
      d: "M12.8,5.4c-0.377-0.504-1.223-0.504-1.6,0l-9,12c-0.228,0.303-0.264,0.708-0.095,1.047 C2.275,18.786,2.621,19,3,19h18c0.379,0,0.725-0.214,0.895-0.553c0.169-0.339,0.133-0.744-0.095-1.047L12.8,5.4z"
...
function StatArrow(props) {
  ...
  return (0, import_jsx_runtime109.jsxs)(import_jsx_runtime109.Fragment, { children: [
    (0, import_jsx_runtime109.jsx)(chakra.span, { srOnly: true, children: label }),
    (0, import_jsx_runtime109.jsx)(BaseIcon, { "aria-hidden": true, ...rest, __css: styles.icon })
  ] });
}
...
var Stepper = forwardRef(function Stepper2(props, ref) {
  ...
  const stepElements = import_react159.Children.toArray(children);
  ...
  return (0, import_jsx_runtime116.jsx)(
    chakra.div,
    {
      ...
      children: (0, import_jsx_runtime116.jsx)(StepperStylesProvider, { value: styles, children: stepElements.map((child, index2) => (0, import_jsx_runtime116.jsx)(
        StepContextProvider,
        {
          value: {
            index: index2,
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react160.useState)(index);
...
function StepStatus(props) {
  ...
  return render ? (0, import_jsx_runtime118.jsx)(import_jsx_runtime118.Fragment, { children: render }) : null;
}
...
function StepIndicatorContent() {
  return (0, import_jsx_runtime122.jsx)(
    StepStatus,
    {
      complete: (0, import_jsx_runtime122.jsx)(StepIcon, {}),
      incomplete: (0, import_jsx_runtime122.jsx)(StepNumber, {}),
      active: (0, import_jsx_runtime122.jsx)(StepNumber, {})
    }
  );
}
...
var Switch = forwardRef(function Switch2(props, ref) {
  ...
  const trackStyles = (0, import_react161.useMemo)(
    () => ({
      display: "inline-flex",
      flexShrink: 0,
  ...
  const labelStyles = (0, import_react161.useMemo)(
    () => ({
      userSelect: "none",
      marginStart: spacing,
      ...styles.label
  ...
  return (0, import_jsx_runtime124.jsxs)(
    chakra.label,
    {
      ...
      __css: containerStyles,
      children: [
        (0, import_jsx_runtime124.jsx)("input", { className: "chakra-switch__input", ...getInputProps({}, ref) }),
...
var Table = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime125.jsx)(TableStylesProvider, { value: styles, children: (0, import_jsx_runtime125.jsx)(
    chakra.table,
    {
      ref,
...
var Thead = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime126.jsx)(chakra.thead, { ...props, ref, __css: styles.thead });
});
...
var Tr = forwardRef((props, ref) => {
  const styles = useTableStyles();
  return (0, import_jsx_runtime127.jsx)(chakra.tr, { ...props, ref, __css: styles.tr });
});
...
var Tbody = forwardRef((props, ref) => {
  const styles = useTableStyles();
  return (0, import_jsx_runtime130.jsx)(chakra.tbody, { ...props, ref, __css: styles.tbody });
});
...
var Tfoot = forwardRef((props, ref) => {
  const styles = useTableStyles();
  return (0, import_jsx_runtime132.jsx)(chakra.tfoot, { ...props, ref, __css: styles.tfoot });
});
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react162.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index) => (0, import_react162.createElement)(
      TabPanelProvider,
      {
        key: index,
        value: {
...
function useTabPanel(props) {
  ...
  const hasBeenSelected = (0, import_react162.useRef)(false);
  if (isSelected) {
...
function useTabIndicator() {
  ...
  const isHorizontal = orientation === "horizontal";
  const isVertical = orientation === "vertical";
  const [rect, setRect] = (0, import_react162.useState)(() => {
    if (isHorizontal)
  ...
  const [hasMeasured, setHasMeasured] = (0, import_react162.useState)(false);
  useSafeLayoutEffect(() => {
...
var Tabs = forwardRef(function Tabs2(props, ref) {
  ...
  const context = (0, import_react163.useMemo)(() => ctx, [ctx]);
  const { isFitted: _, ...rootProps } = htmlProps;
  const tabsStyles = {
    position: "relative",
    ...styles.root
  };
  return (0, import_jsx_runtime134.jsx)(TabsDescendantsProvider, { value: descendants, children: (0, import_jsx_runtime134.jsx)(TabsProvider, { value: context, children: (0, import_jsx_runtime134.jsx)(TabsStylesProvider, { value: styles, children: (0, import_jsx_runtime134.jsx)(
    chakra.div,
    {
...
var Tag = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime140.jsx)(TagStylesProvider, { value: styles, children: (0, import_jsx_runtime140.jsx)(chakra.span, { ref, ...ownProps, __css: containerStyles }) });
});
Tag.displayName = "Tag";
var TagLabel = forwardRef((props, ref) => {
  const styles = useTagStyles();
  return (0, import_jsx_runtime140.jsx)(chakra.span, { ref, noOfLines: 1, ...props, __css: styles.label });
});
TagLabel.displayName = "TagLabel";
var TagLeftIcon = forwardRef((props, ref) => (0, import_jsx_runtime140.jsx)(Icon, { ref, verticalAlign: "top", marginEnd: "0.5rem", ...props }));
TagLeftIcon.displayName = "TagLeftIcon";
var TagRightIcon = forwardRef((props, ref) => (0, import_jsx_runtime140.jsx)(Icon, { ref, verticalAlign: "top", marginStart: "0.5rem", ...props }));
TagRightIcon.displayName = "TagRightIcon";
var TagCloseIcon = (props) => (0, import_jsx_runtime140.jsx)(Icon, { verticalAlign: "inherit", viewBox: "0 0 512 512", ...props, children: (0, import_jsx_runtime140.jsx)(
  "path",
  {
    fill: "currentColor",
  ...
  (props, ref) => {
    ...
    return (0, import_jsx_runtime140.jsx)(
      chakra.button,
      {
        ...
        disabled: isDisabled2,
        __css: btnStyles,
        children: children || (0, import_jsx_runtime140.jsx)(TagCloseIcon, {})
      }
    );
  }
);
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react164.useRef)();
  const clearEnterTimeout = (0, import_react164.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react164.useRef)();
  const clearExitTimeout = (0, import_react164.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react164.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react164.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react164.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
    exitTimeout.current = win.setTimeout(closeNow, closeDelay);
  }, [closeDelay, closeNow, clearEnterTimeout]);
  const onClick = (0, import_react164.useCallback)(() => {
    if (isOpen && closeOnClick) {
      closeWithDelay();
    }
  }, [closeOnClick, closeWithDelay, isOpen]);
  const onPointerDown = (0, import_react164.useCallback)(() => {
  ...
  const getTriggerProps = (0, import_react164.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getTooltipPositionerProps = (0, import_react164.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react164.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef((props, ref) => {
  ...
  let trigger2;
  if (shouldWrap) {
    trigger2 = (0, import_jsx_runtime142.jsx)(
      chakra.span,
      {
        display: "inline-block",
        tabIndex: 0,
    ...
    const child = import_react165.Children.only(children);
    trigger2 = (0, import_react165.cloneElement)(
      child,
  ...
  if (!label) {
    return (0, import_jsx_runtime142.jsx)(import_jsx_runtime142.Fragment, { children });
  }
  return (0, import_jsx_runtime142.jsxs)(import_jsx_runtime142.Fragment, { children: [
    trigger2,
    (0, import_jsx_runtime142.jsx)(AnimatePresence, { children: tooltip.isOpen && (0, import_jsx_runtime142.jsx)(Portal, { ...portalProps, children: (0, import_jsx_runtime142.jsx)(
      chakra.div,
      {
        ...
        children: (0, import_jsx_runtime142.jsxs)(
          MotionDiv3,
          {
            variants: scale2,
            initial: "exit",
            ...
            children: [
              label,
              hasAriaLabel && (0, import_jsx_runtime142.jsx)(chakra.span, { srOnly: true, ...srOnlyProps, children: ariaLabel }),
              hasArrow && (0, import_jsx_runtime142.jsx)(
                chakra.div,
                {
